...
def process_images(opt, image_list, output_folder):
    ...
    json.dump(dets, open(os.path.join(opt.output_folder_json, '_train' + '.json'), 'w'))
...
if __name__ == "__main__":
    ...
    image_list = encontrar_imagenes_png('../images2')
    
    process_images(opt, image_list, './output_ent')
